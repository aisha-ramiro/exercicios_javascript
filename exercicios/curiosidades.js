...
var curiosidade_escolhida_titulo = curiosidade_escolhida.titulo;
var curiosidade_escolhida_conteudo = curiosidade_escolhida.conteudo;

console.log("CURIOSIDADES SOBRE CHUCK NORRIS");
console.log("Título " + curiosidade_escolhida_titulo);
console.log( curiosidade_escolhida_conteudo);